...
const uint32_t TableStruct_messageHeader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpc::MessageHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::rpc::MessageHeader, _impl_.request_size_),
  PROTOBUF_FIELD_OFFSET(::rpc::MessageHeader, _impl_.arg_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::rpc::MessageHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::rpc::_MessageHeader_default_instance_._instance,
};

const char descriptor_table_protodef_messageHeader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023messageHeader.proto\022\003rpc\"7\n\rMessageHea"
  "der\022\024\n\014request_size\030\001 \001(\r\022\020\n\010arg_size\030\003 "
  "\001(\rb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_messageHeader_2eproto = {
    false, false, 91, descriptor_table_protodef_messageHeader_2eproto,
    "messageHeader.proto",
...
MessageHeader::MessageHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:rpc.MessageHeader)
}
MessageHeader::MessageHeader(const MessageHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rpc.MessageHeader)
}
...
MessageHeader::~MessageHeader() {
  // @@protoc_insertion_point(destructor:rpc.MessageHeader)
...
// @@protoc_insertion_point(message_clear_start:rpc.MessageHeader)
...
uint8_t* MessageHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rpc.MessageHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpc.MessageHeader)
  return target;
}

size_t MessageHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpc.MessageHeader)
  size_t total_size = 0;
...
void MessageHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:rpc.MessageHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc.MessageHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void MessageHeader::InternalSwap(MessageHeader* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MessageHeader, _impl_.arg_size_)
      + sizeof(MessageHeader::_impl_.arg_size_)
      - PROTOBUF_FIELD_OFFSET(MessageHeader, _impl_.request_size_)>(
...
template<> PROTOBUF_NOINLINE ::rpc::MessageHeader*
Arena::CreateMaybeMessage< ::rpc::MessageHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpc::MessageHeader >(arena);
}
