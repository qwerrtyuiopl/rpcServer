...
inline const std::string& Request::servicename() const {
  // @@protoc_insertion_point(field_get:rpc.Request.serviceName)
  return _internal_servicename();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Request::set_servicename(ArgT0&& arg0, ArgT... args) {
 
 _impl_.servicename_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc.Request.serviceName)
}
inline std::string* Request::mutable_servicename() {
  std::string* _s = _internal_mutable_servicename();
  // @@protoc_insertion_point(field_mutable:rpc.Request.serviceName)
  return _s;
}
inline const std::string& Request::_internal_servicename() const {
  return _impl_.servicename_.Get();
}
inline void Request::_internal_set_servicename(const std::string& value) {
  
  _impl_.servicename_.Set(value, GetArenaForAllocation());
}
inline std::string* Request::_internal_mutable_servicename() {
  
  return _impl_.servicename_.Mutable(GetArenaForAllocation());
}
inline std::string* Request::release_servicename() {
  // @@protoc_insertion_point(field_release:rpc.Request.serviceName)
...
inline void Request::set_allocated_servicename(std::string* servicename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rpc.Request.serviceName)
}
...
inline const std::string& Request::methodname() const {
  // @@protoc_insertion_point(field_get:rpc.Request.methodName)
  return _internal_methodname();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Request::set_methodname(ArgT0&& arg0, ArgT... args) {
 
 _impl_.methodname_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc.Request.methodName)
}
inline std::string* Request::mutable_methodname() {
  std::string* _s = _internal_mutable_methodname();
  // @@protoc_insertion_point(field_mutable:rpc.Request.methodName)
  return _s;
}
inline const std::string& Request::_internal_methodname() const {
  return _impl_.methodname_.Get();
}
inline void Request::_internal_set_methodname(const std::string& value) {
  
  _impl_.methodname_.Set(value, GetArenaForAllocation());
}
inline std::string* Request::_internal_mutable_methodname() {
  
  return _impl_.methodname_.Mutable(GetArenaForAllocation());
}
inline std::string* Request::release_methodname() {
  // @@protoc_insertion_point(field_release:rpc.Request.methodName)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:rpc.Request.methodName)
}
